...
%**************************************************************************
n=1;Te=2*Tdp;Tf=Te/n; Td=Tdp+Te;  % PD11R controller parameters 
%**************************************************************************
p=0;                                % Fp for p=0
...
%return
%**************************************************************************
n=3;Te=2*Tdp;Tf=Te/n; Td=Tdp+Te;% PD33R controller parameters 
% *************************************************************************
...
%return
%**************************************************************************
 n=5;Te=2*Tdp;Tf=Te/n; Td=Tdp+Te;% PD55R controller parameters
%**************************************************************************
PD5nR_2DOF_Qn
subplot(3,1,1)
...
%**************************************************************************
 n=7;Te=2*Tdp;Tf=Te/n; Td=Tdp+Te;% PD77R controller parameters
%**************************************************************************
PD7nR_2DOF_Qn
subplot(3,1,1)
...
% *************************************************************************
% PDmmR setpoint step responses with Fp for p>1
% *************************************************************************
n=1;Te=2*Tdp;Tf=Te/n; Td=Tdp+Te;% PD11R controller parameters
%**************************************************************************
p=1;                            % Fp for p=1
...
%**************************************************************************
p=1;                            % Fp for p=1
PD3nR_2DOF_Qn                   % simulating loop with PD33R and p=1
subplot(3,1,1)
plot(t,y,'b:','linewidth',2);hold on     % process output
subplot(3,1,2)
plot(t,u,'b:','linewidth',2);hold on     % controller output
...
%**************************************************************************
p=2;                            % Fp for p=2
PD3nR_2DOF_Qn                   % simulating loop with PD33R and p=2
subplot(3,1,1)
plot(t,y,'b--','linewidth',2);hold on     % process output
subplot(3,1,2)
plot(t,u,'b--','linewidth',2);hold on     % controller output
...
plot(t,dir,'b--','linewidth',2);hold on   % reconstructed disturbance
%**************************************************************************
n=5;Te=2*Tdp;Tf=Te/n; Td=Tdp+Te;% controller parameters 
%**************************************************************************
p=1;PD5nR_2DOF_Qn                   % simulating loop with PD55R and p=1
subplot(3,1,1)
plot(t,y,'g:','linewidth',2);hold on
subplot(3,1,2)
plot(t,u,'g:','linewidth',2);hold on
subplot(3,1,3)
plot(t,dir,'g:','linewidth',2);hold on
%**************************************************************************
p=2;PD5nR_2DOF_Qn                   % simulating loop with PD55R and p=2
subplot(3,1,1)
plot(t,y,'g--','linewidth',2);hold on
subplot(3,1,2)
plot(t,u,'g--','linewidth',2);hold on
...
plot(t,dir,'g--','linewidth',2);hold on
%**************************************************************************
n=7;Te=2*Tdp;Tf=Te/n; Td=Tdp+Te;% controller parameters 
%**************************************************************************
p=1;PD7nR_2DOF_Qn               % simulating loop with PD77R and p=1
subplot(3,1,1)
...
%**************************************************************************
p=2;PD7nR_2DOF_Qn               % simulating loop with PD77R and p=2
subplot(3,1,1)
plot(t,y,'r--','linewidth',2);hold on
subplot(3,1,2)
plot(t,u,'r--','linewidth',2);hold on
...
subplot(3,1,1)
ylabel('---> y_s(t)');grid
legend('w','m=1','m=3','m=5','m=7','AV','location','best')
%axis([0 simT -.4 1.4])
subplot(3,1,2)
ylabel('---> u_s(t)');
legend('m=1','m=3','m=5','m=7','AV','location','best')
%axis([0 simT -.02 0.8])
grid
subplot(3,1,3)
legend('m=1','m=3','m=5','m=7','location','best')
ylabel('---> d_{irec}(t)');
xlabel('---> Time t');
%axis([0 simT -0.75 .02 ])
grid
...
plot(t,dir,'g','linewidth',2);hold on   % reconstructed disturbance
%**************************************************************************
 n=7;Te=2*Tdp;Tf=Te/n; Td=Tdp+Te;% PD77R_2DOF_Qn controller parameters
%**************************************************************************
p=0; PD7nR_2DOF_Qn
subplot(3,1,1)
plot(t,y,'r','linewidth',2);hold on     % process output
...
figure(1)
saveas(gcf,'PD11_77R_Te_Tdp_SR.fig')
saveas(gcf,'PD11_77R_Te_Tdp_SR.jpg')
saveas(gcf,'PD11_77R_Te_Tdp_SR.eps')
figure(2)
saveas(gcf,'PD11_77R_Te_Tdp_DR.fig')
saveas(gcf,'PD11_77R_Te_Tdp_DR.jpg')
saveas(gcf,'PD11_77R_Te_Tdp_DR.eps')
