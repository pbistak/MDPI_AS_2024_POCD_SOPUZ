...
%**************************************************************************
n=1;Te=Tdp;Tf=Te/n; Td=Tdp+Te;  % PD11R controller parameters 
%**************************************************************************
p=0;                                % Fp for p=0
...
%return
%**************************************************************************
n=3;Te=Tdp;Tf=Te/n; Td=Tdp+Te;% PD33R controller parameters 
% *************************************************************************
...
%return
%**************************************************************************
 n=5;Te=Tdp;Tf=Te/n; Td=Tdp+Te;% PD55R controller parameters
%**************************************************************************
PD5nR_2DOF_Qn
subplot(3,1,1)
...
%**************************************************************************
 n=7;Te=Tdp;Tf=Te/n; Td=Tdp+Te;% PD77R controller parameters
%**************************************************************************
PD7nR_2DOF_Qn
subplot(3,1,1)
...
plot(t,dir,'b--','linewidth',2);hold on   % reconstructed disturbance
%**************************************************************************
n=5;Te=Tdp;Tf=Te/n; Td=Tdp+Te;% controller parameters 
%**************************************************************************
...
plot(t,dir,'g--','linewidth',2);hold on
%**************************************************************************
n=7;Te=Tdp;Tf=Te/n; Td=Tdp+Te;% controller parameters 
%**************************************************************************
...
plot(t,dir,'g','linewidth',2);hold on   % reconstructed disturbance
%**************************************************************************
 n=7;Te=Tdp;Tf=Te/n; Td=Tdp+Te;% PD77R_2DOF_Qn controller parameters
%**************************************************************************
p=0; PD7nR_2DOF_Qn
subplot(3,1,1)
plot(t,y,'r','linewidth',2);hold on     % process output
