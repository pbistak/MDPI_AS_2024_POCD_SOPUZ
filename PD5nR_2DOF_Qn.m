...
if (n==8) Pn=P8;end
if (n==9) Pn=P9;end
kappa=0.10930;taui=0.12537;               %normed gain and FR time constant
tauD1=2.08980;tauD2=0.84823;tauD3=0.15599;      %normed derivative const.
tauD4=0.01425;tauD5=0.00054;                    %normed derivative const.
t0=1/(7-sqrt(7));                           %normed dominant time constant
